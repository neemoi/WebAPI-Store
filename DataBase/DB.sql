...
--
-- Host: 127.0.0.1    Database: websell
-- ------------------------------------------------------
...
INSERT INTO `__efmigrationshistory` VALUES ('20231016214318_Initial','7.0.12');
...
CREATE TABLE `deliveries` (
  ...
  PRIMARY KEY (`Id`),
  KEY `OrderId` (`OrderId`),
  CONSTRAINT `deliveries_ibfk_1` FOREIGN KEY (`OrderId`) REFERENCES `orders` (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `roles` VALUES ('54b18c4c-e4a6-43ea-89ee-51c93a62f0ea','Admin','ADMIN',NULL),('a36e605c-bbeb-4d70-93ff-efc93340dbcb','a','A',NULL),('d968d618-f044-4a8c-a1ed-164133e36da4','User','USER',NULL);
...
INSERT INTO `userroles` VALUES ('c26d842c-6e43-4ee2-9e05-fa5cf237e6b2','d968d618-f044-4a8c-a1ed-164133e36da4'),('e532e613-6ebb-4bff-abee-4eda9e69f13d','54b18c4c-e4a6-43ea-89ee-51c93a62f0ea');
...
INSERT INTO `users` VALUES ('c26d842c-6e43-4ee2-9e05-fa5cf237e6b2','user','SDS22d!','fsafaf','FSAFAF','aaaaa@fsaf.asf','AAAAA@FSAF.ASF',0,'AQAAAAIAAYagAAAAEFVqjSbhpm4RwNFZqm7mDH0cdajKqc72thYhyK6iM6uuSDrJleD+LvmxnrAjK3xasA==','T5LZIGUZGN7CQRWBNPGI65NHYGSP4FBJ','54bdeaf2-4285-4bf3-8c9e-eb52f3ae4b91','13412',0,0,NULL,1,0),('e532e613-6ebb-4bff-abee-4eda9e69f13d','admin','admin@1Q','admin','ADMIN','admin@example.com','ADMIN@EXAMPLE.COM',0,'AQAAAAIAAYagAAAAEHqVN2mAjzfnp8ewX7wjI+10eyfWBfXgLcTZVGHV+76qQlC+e8Dv9YZMIlsYkWlCng==','ZQ324PK2MAXMJ3FVAJDTCAVDW4AVPLGM','deae34d5-7a60-4bde-a1da-61cf6828ac22','43146210',0,0,NULL,1,0);
...
-- Dump completed on 2023-11-02  0:39:29
